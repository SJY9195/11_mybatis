...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *
        * -------------------------------
        * PooledDateSource : ConnectionPool 을 사용함.   //Connection 객체를 미리 만들어 놓는것이 ConnectionPool 이다!
        ...
        * */
        ...
        config.addMapper(Mapper.class);
                 ...
                 * sqlSessionFactory 타입의 객체를 생성하기 위한 빌드 역할
                 * build() : 설정에 대한 정보를 담고 있는 configuration 타입의 객체 혹은 외부 설정 파일
        ...
        SqlSession session = sqlSessionFactory.openSession(false);   //공장에 session 담아서 쿼리문 처리!!
